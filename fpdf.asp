...
function FPDF()
	...
	this.Interlinea=0;
	//mio
	this.Setnombre=function Setnombre(nom){
	   this.nombre = nom
	}
	...
	// Cambiado por mi, estaba vacia.	
	this.Header=function Header(){
       this.SetFont('Arial','B',11);
	   this.SetTextColor(0,51,102);
       this.Cell(50);
       this.Cell(0,10,'Informe para la empresa|usuario: ' + this.nombre,0,0,'R');
       this.Ln(10);
	}
	//Cambiado por mi., estaba vacia.
	this.Footer=function Footer() {
	  ...
	  this.Cell(80,10,'Fecha actual: '+ fecha_pie.getDate() + ' / ' + (fecha_pie.getMonth() + 1) + ' / ' + fecha_pie.getYear() ,0,0,'L');
